...
console.log(doubleThePopulation(5), doubleThePopulation(6.12), doubleThePopulation(8526), doubleThePopulation(6));
...
function languagesSpoken(country, language1, language2) {
    let countryLanguages = `The languages spoken in ${country} are: ${language1} `;
    if (typeof language2 === 'string') {
        countryLanguages += `${language2}`;
    }
